    ...
    stages {
        stage('Build') { 
            ...
            steps {
                ...
                sh 'ulimit -Sn 65535 && assets/bcl-convert --output-directory temp/Demultiplexing --bcl-input-directory temp --strict-mode true --bcl-sampleproject-subdirectories true --sample-name-column-enabled true --force > temp/bcl-convert.out 2> temp/bcl-convert.err'
